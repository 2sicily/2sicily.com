    ...
    <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 pb-8">
        ...
        <div className="flex-none w-full mb-2 overflow-hidden">
          ...
          <img className="bg-gray-100 object-cover h-60 w-full border border-brand-zero" src={item.data.primary_image.url} alt="" />
            <div className="absolute right-0 top-0 bg-brand-white group-hover:bg-brand-three py-2 px-2 rounded-none border-brand-zero border-l border-b space-x-1 flex-auto text-black text-sm font-light inline-flex items-center justify-end w-auto">
          ...
          <div className="flex-1 flex sm:flex-row pt-2 w-full flex-col">
            <div className="py-0.5 text-base text-left flex-auto text-black font-serif truncate w-full">{item.data.accommodation_name}</div>
            <div className="flex-1"></div>
            {/* <div className="py-0.5 space-x-1 flex-auto text-black text-sm font-light inline-flex items-center justify-start sm:justify-end w-full sm:w-auto sm:mt-0 mt-1">
          ...
          <div className="flex-1 flex sm:flex-row pb-2 w-full flex-col">
            <div className="py-0.5 space-x-1 flex-auto text-black text-sm font-light inline-flex items-center justify-start sm:justify-start w-full sm:mt-0">
            ...
            <span className="py-0.5 flex-auto truncate text-black text-sm font-light inline-flex items-center justify-start sm:justify-end w-full sm:mt-0 mt-1">€{item.data.price_per_night} / night</span>
          </div>
        </li>
        </Link>
      ))}
